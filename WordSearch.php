...
class WordSearch {
    ...
    function DisplayHTML() {
                    ...
                    <TABLE border="0" cellpadding="0" cellspacing="0" align="left"
                        ...
                        <TR>
                            <TD valign="top">
                                <?php
                                for ($i = 0;
                                $i < count($this->_wordlist);
                                $i++) {
                                if ($i % 40 == 0 && $i > 0) {
                                ?></TD>
                            <TD valign="top"
                                style="padding-left: 3px; border-left: solid black 1px;"><?php
                                }
        ...
        <TABLE border="0" align="center"
               style="color: grey; font-size: 8pt; font-family: Times Roman, Arial;">
            <TR>
                <TD valign="middle">
                    <IMG src="wordsearcher.png" width="16" height="16" border="0" alt=""
                         align="right" style="-moz-opacity: 0.2;">
                </TD>
                <TD align="center">
                    <?php
                    if( $this->_show_date ) {
